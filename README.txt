...
# Summary
#########################################################################################################
The SIS Baseline Profile (SBP) Agent Framework is a basic .NET Framework intended to help developing 
...
==============================
From the command-line type: git clone git@github.com:nsip/SbpAgentFramework-dotNet.git
