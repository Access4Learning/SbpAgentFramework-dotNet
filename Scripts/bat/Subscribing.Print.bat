...
set EXECUTABLE_PATH=\soe\Projects\SbpAgentFramework\Code\SbpAgentFramework\Systemic.Sif.Sbp.Demo.Subscribing.Print\bin\Release\
set EXECUTABLE=Systemic.Sif.Sbp.Demo.Subscribing.Print.exe
